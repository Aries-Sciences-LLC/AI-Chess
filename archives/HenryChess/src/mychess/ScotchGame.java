...
public class ScotchGame extends Opening{
	...
	public ScotchGame(Chessboard board){
		...
		openingMove [27] = new Move(board.objectAt(2,7),4,5,true);
                varArray[0] = false; varArray[1] = false; 
                misArray[0] = false; misArray[1] = false;
	}
  ...
  /*          if (m== 15 && !varArray[0] && rGen.nextInt(2)==0){
                System.out.println("Variation 3");
                openingMove[15]= new Move(board.objectAt(3,6),4,6,true);
                size = 16;
            }*/
