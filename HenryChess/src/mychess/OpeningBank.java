...
//      private Opening [] opening = new Opening [1];
	...
	private static String [] openingArray = {"Scotch Game", "Giuoco Piano",
                "Sicilian Defence (Schevingen)",  "Sicilian Defence (Dragon)", 
                "Queen Gambit Declined", "Ruy Lopez", "Evans Gambit Declined", "Max Lange",
		"Danish Gambit Accepted", "Benoni Counter Gambit", "Philidor's Defence", 
                "Colle System", "Bishop Opening", "KingsGambit"};
	...
	public Move getOpeningMove(int m){
            ...
            for (int i=0; i<opening.length; i++){
                if (m==0){
                    ...
                    System.out.println("opening: "+ openingArray[i]);
